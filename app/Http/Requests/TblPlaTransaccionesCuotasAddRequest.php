...
class TblPlaTransaccionesCuotasAddRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"tc_tr_id" => "required|numeric",
				"tc_cant_cuotas" => "required|numeric",
				"tc_monto" => "required|numeric",
				"tc_montobs" => "nullable|numeric",
				"tc_estado" => "required|string",
