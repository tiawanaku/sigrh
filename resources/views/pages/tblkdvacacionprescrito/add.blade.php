            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblkdvacacionprescrito-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblkdvacacionprescrito.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-vpre_va_id-holder" class=" ">
                                                <input id="ctrl-vpre_va_id" data-field="vpre_va_id"  value="<?php echo get_value('vpre_va_id') ?>" type="number" placeholder="Escribir Vpre Va Id" step="any"  name="vpre_va_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-vpre_nro_documento-holder" class=" ">
                                                <input id="ctrl-vpre_nro_documento" data-field="vpre_nro_documento"  value="<?php echo get_value('vpre_nro_documento') ?>" type="text" placeholder="Escribir Vpre Nro Documento"  name="vpre_nro_documento"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-vpre_autorizado_por-holder" class=" ">
                                                <input id="ctrl-vpre_autorizado_por" data-field="vpre_autorizado_por"  value="<?php echo get_value('vpre_autorizado_por') ?>" type="text" placeholder="Escribir Vpre Autorizado Por"  name="vpre_autorizado_por"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-vpre_estado-holder" class=" ">
                                                <input id="ctrl-vpre_estado" data-field="vpre_estado"  value="<?php echo get_value('vpre_estado') ?>" type="text" placeholder="Escribir Vpre Estado"  name="vpre_estado"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-vpre_usuario_creacion-holder" class=" ">
                                                <input id="ctrl-vpre_usuario_creacion" data-field="vpre_usuario_creacion"  value="<?php echo get_value('vpre_usuario_creacion') ?>" type="number" placeholder="Escribir Vpre Usuario Creacion" step="any"  name="vpre_usuario_creacion"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
