            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tblbsafp/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_per_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['afp_per_id'] ? 'selected' : null );
                                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_previsora-holder" class=" ">
                                            <input id="ctrl-afp_previsora" data-field="afp_previsora"  value="<?php  echo $data['afp_previsora']; ?>" type="text" placeholder="Escribir Afp Previsora"  required="" name="afp_previsora"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_nua-holder" class=" ">
                                            <input id="ctrl-afp_nua" data-field="afp_nua"  value="<?php  echo $data['afp_nua']; ?>" type="text" placeholder="Escribir Afp Nua"  name="afp_nua"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_motivo_modificacion-holder" class=" ">
                                            <input id="ctrl-afp_motivo_modificacion" data-field="afp_motivo_modificacion"  value="<?php  echo $data['afp_motivo_modificacion']; ?>" type="text" placeholder="Escribir Afp Motivo Modificacion"  name="afp_motivo_modificacion"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_estado_carnet-holder" class=" ">
                                            <input id="ctrl-afp_estado_carnet" data-field="afp_estado_carnet"  value="<?php  echo $data['afp_estado_carnet']; ?>" type="text" placeholder="Escribir Afp Estado Carnet"  name="afp_estado_carnet"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_usuario-holder" class=" ">
                                            <input id="ctrl-afp_usuario" data-field="afp_usuario"  value="<?php  echo $data['afp_usuario']; ?>" type="number" placeholder="Escribir Afp Usuario" step="any"  required="" name="afp_usuario"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-afp_estado-holder" class=" ">
                                            <input id="ctrl-afp_estado" data-field="afp_estado"  value="<?php  echo $data['afp_estado']; ?>" type="text" placeholder="Escribir Afp Estado"  required="" name="afp_estado"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
