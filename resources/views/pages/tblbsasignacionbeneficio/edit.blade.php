            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tblbsasignacionbeneficio/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ab_aeb_id-holder" class=" ">
                                            <input id="ctrl-ab_aeb_id" data-field="ab_aeb_id"  value="<?php  echo $data['ab_aeb_id']; ?>" type="number" placeholder="Escribir Ab Aeb Id" step="any"  required="" name="ab_aeb_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ab_fa_id-holder" class=" ">
                                            <input id="ctrl-ab_fa_id" data-field="ab_fa_id"  value="<?php  echo $data['ab_fa_id']; ?>" type="number" placeholder="Escribir Ab Fa Id" step="any"  required="" name="ab_fa_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ab_estado-holder" class=" ">
                                            <input id="ctrl-ab_estado" data-field="ab_estado"  value="<?php  echo $data['ab_estado']; ?>" type="text" placeholder="Escribir Ab Estado"  required="" name="ab_estado"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ab_tipo_beneficiario-holder" class=" ">
                                            <input id="ctrl-ab_tipo_beneficiario" data-field="ab_tipo_beneficiario"  value="<?php  echo $data['ab_tipo_beneficiario']; ?>" type="text" placeholder="Escribir Ab Tipo Beneficiario"  name="ab_tipo_beneficiario"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
