            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblpersonafoto-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblpersonafoto.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-fp_id-holder" class=" ">
                                                <input id="ctrl-fp_id" data-field="fp_id"  value="<?php echo get_value('fp_id') ?>" type="number" placeholder="Escribir Fp Id" step="any"  required="" name="fp_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-fp_per_id-holder" class=" ">
                                                <input id="ctrl-fp_per_id" data-field="fp_per_id"  value="<?php echo get_value('fp_per_id') ?>" type="number" placeholder="Escribir Fp Per Id" step="any"  required="" name="fp_per_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-fp_foto-holder" class=" ">
                                                <div class="dropzone required" input="#ctrl-fp_foto" fieldname="fp_foto" uploadurl="{{ url('fileuploader/upload/fp_foto') }}"    data-multiple="false" dropmsg="Elija archivos o suelte archivos aquí"    btntext="Vistazo" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                    <input name="fp_foto" id="ctrl-fp_foto" data-field="fp_foto" required="" class="dropzone-input form-control" value="<?php echo get_value('fp_foto') ?>" type="text"  />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-fp_estado-holder" class=" ">
                                                <input id="ctrl-fp_estado" data-field="fp_estado"  value="<?php echo get_value('fp_estado') ?>" type="text" placeholder="Escribir Fp Estado"  required="" name="fp_estado"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
