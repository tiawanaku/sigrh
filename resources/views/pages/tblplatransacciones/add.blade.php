            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblplatransacciones-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblplatransacciones.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tr_pc_id-holder" class=" ">
                                                <input id="ctrl-tr_pc_id" data-field="tr_pc_id"  value="<?php echo get_value('tr_pc_id') ?>" type="number" placeholder="Escribir Tr Pc Id" step="any"  required="" name="tr_pc_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tr_per_id-holder" class=" ">
                                                <input id="ctrl-tr_per_id" data-field="tr_per_id"  value="<?php echo get_value('tr_per_id') ?>" type="number" placeholder="Escribir Tr Per Id" step="any"  required="" name="tr_per_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tr_fa_id-holder" class=" ">
                                                <input id="ctrl-tr_fa_id" data-field="tr_fa_id"  value="<?php echo get_value('tr_fa_id') ?>" type="number" placeholder="Escribir Tr Fa Id" step="any"  required="" name="tr_fa_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tr_monto-holder" class=" ">
                                                <input id="ctrl-tr_monto" data-field="tr_monto"  value="<?php echo get_value('tr_monto') ?>" type="number" placeholder="Escribir Tr Monto" step="0.1"  required="" name="tr_monto"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-tr_usuario_creacion-holder" class=" ">
                                                <input id="ctrl-tr_usuario_creacion" data-field="tr_usuario_creacion"  value="<?php echo get_value('tr_usuario_creacion') ?>" type="number" placeholder="Escribir Tr Usuario Creacion" step="any"  name="tr_usuario_creacion"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
