            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblcpcierremensual-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblcpcierremensual.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cm_id-holder" class=" ">
                                                <input id="ctrl-cm_id" data-field="cm_id"  value="<?php echo get_value('cm_id') ?>" type="number" placeholder="Escribir Cm Id" step="any"  required="" name="cm_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cm_estado-holder" class=" ">
                                                <input id="ctrl-cm_estado" data-field="cm_estado"  value="<?php echo get_value('cm_estado') ?>" type="text" placeholder="Escribir Cm Estado"  required="" name="cm_estado"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
