            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tblrfstareasrecurrentes/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-tr_poai_id-holder" class=" ">
                                            <input id="ctrl-tr_poai_id" data-field="tr_poai_id"  value="<?php  echo $data['tr_poai_id']; ?>" type="number" placeholder="Escribir Tr Poai Id" step="any"  name="tr_poai_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-tr_descripcion-holder" class=" ">
                                            <input id="ctrl-tr_descripcion" data-field="tr_descripcion"  value="<?php  echo $data['tr_descripcion']; ?>" type="text" placeholder="Escribir Tr Descripcion"  required="" name="tr_descripcion"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
