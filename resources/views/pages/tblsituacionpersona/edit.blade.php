            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tblsituacionpersona/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-st_id-holder" class=" ">
                                            <input id="ctrl-st_id" data-field="st_id"  value="<?php  echo $data['st_id']; ?>" type="number" placeholder="Escribir St Id" step="any"  required="" name="st_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-st_per_id-holder" class=" ">
                                            <input id="ctrl-st_per_id" data-field="st_per_id"  value="<?php  echo $data['st_per_id']; ?>" type="number" placeholder="Escribir St Per Id" step="any"  name="st_per_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-st_tipo_situacion-holder" class=" ">
                                            <input id="ctrl-st_tipo_situacion" data-field="st_tipo_situacion"  value="<?php  echo $data['st_tipo_situacion']; ?>" type="text" placeholder="Escribir St Tipo Situacion"  name="st_tipo_situacion"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-st_estado-holder" class=" ">
                                            <input id="ctrl-st_estado" data-field="st_estado"  value="<?php  echo $data['st_estado']; ?>" type="text" placeholder="Escribir St Estado"  name="st_estado"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-st_usuario_creacion-holder" class=" ">
                                            <input id="ctrl-st_usuario_creacion" data-field="st_usuario_creacion"  value="<?php  echo $data['st_usuario_creacion']; ?>" type="number" placeholder="Escribir St Usuario Creacion" step="any"  name="st_usuario_creacion"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
