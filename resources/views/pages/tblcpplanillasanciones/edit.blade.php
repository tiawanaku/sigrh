            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("tblcpplanillasanciones/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ps_cp_id-holder" class=" ">
                                            <input id="ctrl-ps_cp_id" data-field="ps_cp_id"  value="<?php  echo $data['ps_cp_id']; ?>" type="number" placeholder="Escribir Ps Cp Id" step="any"  required="" name="ps_cp_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-ps_cm_id-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['ps_cm_id'] ? 'selected' : null );
                                            ?>
