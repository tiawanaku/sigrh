            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblcpcontrolespersonal-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblcpcontrolespersonal.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cp_id-holder" class=" ">
                                                <input id="ctrl-cp_id" data-field="cp_id"  value="<?php echo get_value('cp_id') ?>" type="number" placeholder="Escribir Cp Id" step="any"  required="" name="cp_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cp_per_id-holder" class=" ">
                                                <input id="ctrl-cp_per_id" data-field="cp_per_id"  value="<?php echo get_value('cp_per_id') ?>" type="number" placeholder="Escribir Cp Per Id" step="any"  required="" name="cp_per_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-cp_edificio-holder" class=" ">
                                                <input id="ctrl-cp_edificio" data-field="cp_edificio"  value="<?php echo get_value('cp_edificio') ?>" type="number" placeholder="Escribir Cp Edificio" step="any"  required="" name="cp_edificio"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
